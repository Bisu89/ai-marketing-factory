...
def _build_user_message(video: Video, extra_context: str | None = None) -> str:
    ...
    # Task 04 -- app/api/v1/endpoints/content_idea_generation.py (the
    # composition root that bridges app.modules.content_strategy into this
    # module) is the only caller that ever passes this. Every other caller
    # (plain POST /story-jobs) leaves it None, so the message above is
